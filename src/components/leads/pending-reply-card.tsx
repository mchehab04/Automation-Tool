...
import { sendPendingReply } from "@/lib/actions/reply";

export function PendingReplyCard({ leadId, draft }: { leadId: string; draft: string }) {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Sparkles className="size-4" /> Reply drafted by AI
        </CardTitle>
