...
const latestChange = {
	badge: "NEW",
	title: "Reason codes on close",
	description: "See why leads win or lose.", // TIP: Use a single line of text for the description. (max 5 words)
	readMore: { href: "/leads", label: "See it in action" },
} as const;
