...
```bash
cd /Users/nicksaraev/Business && .venv/bin/python .claude/skills/model-chat/model_chat.py "<topic>"
```

For interactive mode:
```bash
cd /Users/nicksaraev/Business && .venv/bin/python .claude/skills/model-chat/model_chat.py "<topic>" --interactive
```
